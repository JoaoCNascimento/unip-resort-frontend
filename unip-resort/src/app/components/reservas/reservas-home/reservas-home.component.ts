...
export class ReservasHomeComponent implements OnInit {
  ...
  categorias: Categoria[] = [
    ...
    },
    {
      ...
      nome: 'Suíte de Luxo',
      descricao: 'Quarto com banheira de hidromassagem, smart tv 55", frigobar, serviço de quarto disponível 24 horas e muito mais!',
      imageUrl: 'https://f.i.uol.com.br/fotografia/2019/05/08/15573410505cd3237a49e89_1557341050_3x2_md.jpg',
      precoDiaria: 240
    },
  ];
