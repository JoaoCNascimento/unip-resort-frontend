...
export class ReservasHomeComponent implements OnInit {
  ...
  categorias: Categoria[] = [
    ...
    },
    {
      ...
      nome: "Suíte VIP",
      descricao:
        'Quarto com banheira de hidromassagem, smart tv 55", frigobar, serviço de quarto disponível 24 horas e muito mais!',
      imageUrl:
        "https://startupi.com.br/wp-content/uploads/2016/08/hotel-1.jpg",
        status: false,
      precoDiaria: 270,
    },
    {
      ...
      descricao:
        'Quarto com banheira de hidromassagem, smart tv 55", frigobar, serviço de quarto disponível 24 horas e muito mais!',
      imageUrl:
        "https://f.i.uol.com.br/fotografia/2019/05/08/15573410505cd3237a49e89_1557341050_3x2_md.jpg",
        status: false,
      precoDiaria: 240,
    },
  ];
  ...
  goToReservar(id) {
    this.router.navigate(["reservas", "nova-reserva", id], {
